...
from pascal.security.jwt import JwtAuth, TokenValidationError
from pascal.tools.context import McpCluster, mcp_from_request
    ...
    *,
    ...
    def get_identity(request: Request, claims: dict = Depends(require_chat)) -> Identity:
        ...
        return Identity(
            ...
            mcp=mcp_from_request(request, config),
        )
