"""Pascal's existing model/tool loop, with one graph for JSON and SSE.

HTTP, prompts/history, discovery/filtering, MCP and persistence stay in app.py.
Each graph captures this request's dependencies; no global tool catalogue or memory.
"""
